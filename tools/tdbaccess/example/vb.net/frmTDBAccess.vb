...
Public Class frmTDBAccess
    ...
    Friend WithEvents cmsTables As ContextMenuStrip
    Friend WithEvents mnuTablesSetCapacity As ToolStripMenuItem
    Friend WithEvents hColTableRecords As ColumnHeader
        ...
        If OpenIndex <> -1 Then
            ...
            For i = 0 To TableListSize - 1
                ...
                If TDBTableGetProperties(OpenIndex, i, TableProps) Then
                    ...
                    lstTables.Items(i).SubItems.Add(String.Format("{0:d} / {1:d} records ({2:d} deleted)", TableProps.RecordCount, TableProps.Capacity, TableProps.DeletedCount))
                End If
            Next
            lstTables.EndUpdate()
        End If
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.hColTableRecords = CType(New System.Windows.Forms.ColumnHeader(), System.Windows.Forms.ColumnHeader)
        Me.cmsTables = New System.Windows.Forms.ContextMenuStrip(Me.components)
        Me.mnuTablesSetCapacity = New System.Windows.Forms.ToolStripMenuItem()
        ...
        Me.lstTables.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.hcolTableName, Me.hColTableRecords})
        Me.lstTables.ContextMenuStrip = Me.cmsTables
        ...
        Me.lstTables.Size = New System.Drawing.Size(269, 447)
        ...
        Me.hcolTableName.Width = 70
        '
        'hColTableRecords
        '
        Me.hColTableRecords.Text = "Records"
        Me.hColTableRecords.Width = 100
        '
        'cmsTables
        '
        Me.cmsTables.ImageScalingSize = New System.Drawing.Size(24, 24)
        Me.cmsTables.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.mnuTablesSetCapacity})
        Me.cmsTables.Name = "cmsTables"
        Me.cmsTables.Size = New System.Drawing.Size(182, 36)
        '
        'mnuTablesSetCapacity
        '
        Me.mnuTablesSetCapacity.Name = "mnuTablesSetCapacity"
        Me.mnuTablesSetCapacity.Size = New System.Drawing.Size(181, 32)
        Me.mnuTablesSetCapacity.Text = "Set Capacity"
        '
        'lstFields
        '
        ...
        Me.lstFields.Location = New System.Drawing.Point(270, 0)
        Me.lstFields.MultiSelect = False
        Me.lstFields.Name = "lstFields"
        Me.lstFields.Size = New System.Drawing.Size(242, 447)
        ...
        Me.hcolFieldname.Width = 70
        '
        'hcolFieldSize
        '
        Me.hcolFieldSize.Text = "Field Size"
        Me.hcolFieldSize.Width = 70
        '
        'Timer
        '
        ...
        Me.cmsTables.ResumeLayout(False)
...
#End Region
    ...
    Private Sub Timer_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer.Tick
        ...
        mnuTablesSetCapacity.Enabled = (lstTables.SelectedItems.Count > 0) And (OpenIndex <> -1)
    End Sub

    Private Sub mnuTablesSetCapacity_Click(sender As Object, e As EventArgs) Handles mnuTablesSetCapacity.Click
        If (lstTables.SelectedItems.Count > 0) And (OpenIndex <> -1) Then
            'Retrieve the selected table's properties
            Dim TableProps As TdbTableProperties
            TableProps.Name = Nothing
            If Not TDBTableGetProperties(OpenIndex, lstTables.SelectedIndices(0), TableProps) Then
                MessageBox.Show("Unable to retrieve table properties.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand)
                Return
            End If
            'Determine the current capacity as string
            Dim CurrentCapacityStr As String = CStr(TableProps.Capacity)
            'Show input box to set new capacity
            Dim NewCapacityStr As String = InputBox("Enter new capacity for table '" & lstTables.SelectedItems(0).Text & "':", "Set Table Capacity", CurrentCapacityStr)
            If NewCapacityStr = "" Then
                'User cancelled the input box
                Return
            End If
            'Make sure the input is a valid integer
            Dim NewCapacity As Integer
            If (Not Integer.TryParse(NewCapacityStr, NewCapacity)) Or (NewCapacity >= 65535) Or (NewCapacity < 0) Then
                MessageBox.Show("Table capacity should be a number between 0 and 65534", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand)
                Return
            End If
            'Set the new capacity
            If Not TDBTableChangeCapacity(OpenIndex, SelectedTable, NewCapacity) Then
                MessageBox.Show("Unable to set new capacity.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand)
                Return
            End If
